...
##
## Input
##   Barks_etal_2014_viaDeCasien2019_snapshot.xlsx
...
##
## Output
##   Barks_etal_2014_viaDeCasien2019.csv
...
item_name <- tools::file_path_sans_ext(basename(.sp))    # Barks_etal_2014_viaDeCasien2019
