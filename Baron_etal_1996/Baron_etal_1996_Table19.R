# Baron, Stephan & Frahm 1996, Table19: volumes of the vestibular nuclei of the medulla oblongata.
# Frozen source: Baron_etal_1996_Table19_snapshot.csv, produced by the coordinate-based
...
final.dataframe <- data.frame(
  ...
  vestibular_complex_mm3 = as.numeric(snapshot$VC),
  nucleus_vestibularis_medialis_mm3 = as.numeric(snapshot$VM),
  nucleus_vestibularis_inferior_mm3 = as.numeric(snapshot$VI),
  nucleus_vestibularis_lateralis_mm3 = as.numeric(snapshot$VL),
  nucleus_vestibularis_superior_mm3 = as.numeric(snapshot$VS),
  source_pdf_page = snapshot$source_pdf_page,
  stringsAsFactors = FALSE
)

required <- c("species_row", "Species_Baron1996", "vestibular_complex_mm3", "nucleus_vestibularis_medialis_mm3", "nucleus_vestibularis_inferior_mm3", "nucleus_vestibularis_lateralis_mm3", "nucleus_vestibularis_superior_mm3")
