# Baron, Stephan & Frahm 1996, Table39: Lutgemeier's (1962) cortical surface-area measurements, reprinted in the book. Secondary.
# Frozen source: Baron_etal_1996_Table39_snapshot.csv, produced by the coordinate-based
...
final.dataframe <- data.frame(
  ...
  bicortex_mm2 = as.numeric(snapshot$BIC),
  source_pdf_page = snapshot$source_pdf_page,
  stringsAsFactors = FALSE
)

required <- c("species_row", "Species_Baron1996", "total_cortex_mm2", "neocortex_mm2", "allocortex_mm2", "semicortex_mm2", "schizocortex_mm2", "bicortex_mm2")
