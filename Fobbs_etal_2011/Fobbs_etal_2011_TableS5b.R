# Fobbs_etal_2011_TableS5b.R
#
# Complete build pipeline for Fobbs & Johnson (2011), supplementary TableS5b:
...
#
# Source  : nyas_6036_sm_table5b.doc
# Helper  : Fobbs_etal_2011_build_snapshot.py
# Snapshot: Fobbs_etal_2011_TableS5b_snapshot.xlsx, sheet "TableS5b"
# Outputs : Fobbs_etal_2011_TableS5b.csv
...
source_doc <- "nyas_6036_sm_table5b.doc"
...
raw <- read_excel(snapshot_xlsx, sheet="TableS5b", skip=1, col_names=TRUE, col_types="text")
if (ncol(raw) != 7L) stop("Expected 7 columns; found ", ncol(raw), ".", call.=FALSE)
names(raw) <- c("animal_number", "common_name", "stains", "plane", "non_mammal_clade", "number_of_slides", "comments")
