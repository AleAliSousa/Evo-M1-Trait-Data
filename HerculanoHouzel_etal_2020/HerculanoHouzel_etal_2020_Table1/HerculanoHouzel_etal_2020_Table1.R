## 1. SOURCE
setwd("~/Library/CloudStorage/OneDrive-AllenInstitute/Species/Evo M1 Trait Data/HerculanoHouzel_etal_2020/HerculanoHouzel_etal_2020_Table1")
...
write.csv(df1, file = "10.1002%2Fcne.24985_table1.tsv", row.names = FALSE)
