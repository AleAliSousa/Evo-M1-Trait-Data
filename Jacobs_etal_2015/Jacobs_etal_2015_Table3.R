...
## Table 3. Evaluation of effects in initial exploratory models
##
## Input  : Jacobs_etal_2015_Table3_snapshot.csv  (hand-transcribed, verbatim copy
##          of the printed Table 3, p. 2863 of the PDF)
## Output : Jacobs_etal_2015_Table3.csv
##          __Public/comparative-data/<Item encoded>.tsv
##
## Table 3 reports GENLIN model-fit statistics for six dendritic/spine measures
## (DSC, DSD, DSN, MSL, TDL, Vol; abbreviations defined in the paper's Table 2)
## across giraffe motor vs. visual cortex. No numeric re-derivation is performed;
## Wald/Pearson chi-square statistics and p-values are carried through as printed.
