...
## Input: PanTHERIA_1-0_WR93_Aug2008.txt (original tab-delimited publication file; treated as frozen snapshot)
## Output: Jones_etal_2009_PanTHERIA1-0WR93Aug2008.txt.csv and encoded public .txt from __ReadMe.xlsx
