# Table S5 sheet 2: snRNA-seq subclass counts and proportions
...
- Source table/result set: Table S5 / snRNA_prop
- Data role: Primary counts plus derived within-area subclass proportions
- Rows: 600
- Columns: 6
