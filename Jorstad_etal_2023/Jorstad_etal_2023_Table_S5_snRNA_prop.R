...
# Rows and columns retained unchanged from the source sheet
x <- readxl::read_excel("Table_S5_MERFISH_snRNA_prop_EI.xlsx", sheet = "snRNA_prop")
write.csv(x, "Jorstad_etal_2023_Table_S5_snRNA_prop.csv",
