## Kamiya_Pirlot_1988_Table1
## Input : Kamiya_Pirlot_1988_Table1_snapshot.csv
## Output: Kamiya_Pirlot_1988_Table1.csv and DOI-coded public TSV from __ReadMe.xlsx
options(scipen=999)
.sp <- local({
...
snap <- read.csv("Kamiya_Pirlot_1988_Table1_snapshot.csv", check.names=FALSE, stringsAsFactors=FALSE, na.strings=c("","NA"))
stopifnot(nrow(snap)==10L)
clean <- snap; clean$source <- "Kamiya_Pirlot_1988_Table1"
