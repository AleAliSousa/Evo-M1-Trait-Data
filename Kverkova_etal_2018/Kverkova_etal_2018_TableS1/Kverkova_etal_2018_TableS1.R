...
# ADD A STEP HERE:
# Use Tidyverse to make new columns based on the percentage of brain values
...
write.csv(df1_combined, file = "10.1038%2Fs41598-018-26062-8_tables1.tsv", row.names = FALSE)
