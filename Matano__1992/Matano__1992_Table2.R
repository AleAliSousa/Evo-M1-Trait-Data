...
#
#   Table 2. Body weight, volumes of the inferior olivary nuclei and eco-ethological
#   characteristics in New World monkeys (12 species).
#
...
#
# Input
#   Matano__1992_Table2_snapshot.csv   journal-faithful transcription of the printed
#     table (the data rows are scanned images with no text layer, so this hand-read
#     snapshot is the frozen source).
#
# Outputs
#   Matano__1992_Table2.csv                          12 species
#   10.1537%2Fase1911.100.69_Table2.tsv              in __Public/comparative-data/
#
...
stopifnot(nrow(out) == 12L, max(resid) <= 0.06)
