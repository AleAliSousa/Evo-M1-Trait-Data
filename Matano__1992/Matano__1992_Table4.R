...
#
#   Table 4. Body weight, volumes of the inferior olivary nuclei and eco-ethological
#   characteristics in apes and Man (4 species: Hylobates, Pan, Gorilla + Homo).
#
...
#
# Input
#   Matano__1992_Table4_snapshot.csv   journal-faithful transcription of the printed
#     table (the data rows are scanned images with no text layer, so this hand-read
#     snapshot is the frozen source).
#
# Outputs
#   Matano__1992_Table4.csv                          4 species
#   10.1537%2Fase1911.100.69_Table4.tsv              in __Public/comparative-data/
#
...
stopifnot(nrow(out) == 4L, max(resid) <= 0.06)
