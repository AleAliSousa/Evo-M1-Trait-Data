## Pirlot__1981_TABLEI
## Input : Pirlot__1981_TABLEI_snapshot.csv
## Output: Pirlot__1981_TABLEI.csv and DOI-coded public TSV from __ReadMe.xlsx
options(scipen=999)
.sp <- local({
...
snap <- read.csv("Pirlot__1981_TABLEI_snapshot.csv", check.names=FALSE, stringsAsFactors=FALSE, na.strings=c("","NA"))
stopifnot(nrow(snap)==50L)
clean <- snap; clean$source <- "Pirlot__1981_TABLEI"
