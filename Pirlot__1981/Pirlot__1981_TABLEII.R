## Pirlot__1981_TABLEII
## Input : Pirlot__1981_TABLEII_snapshot.csv
## Output: Pirlot__1981_TABLEII.csv and DOI-coded public TSV from __ReadMe.xlsx
options(scipen=999)
.sp <- local({
...
snap <- read.csv("Pirlot__1981_TABLEII_snapshot.csv", check.names=FALSE, stringsAsFactors=FALSE, na.strings=c("","NA"))
stopifnot(nrow(snap)==28L)
clean <- snap; clean$source <- "Pirlot__1981_TABLEII"
