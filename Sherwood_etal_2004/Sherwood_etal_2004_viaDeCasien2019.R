...
folder    <- dirname(.sp)
item_name <- tools::file_path_sans_ext(basename(.sp))    # Sherwood_etal_2004_viaDeCasien2019
base      <- local({
  d <- folder
