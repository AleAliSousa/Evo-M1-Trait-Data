...
`Todorov_etal_2019_dimorphdata.R` extracts and validates its `dimorphdata.csv`
member, producing `Todorov_etal_2019_dimorphdata.csv`. The output has 12 species
...
`reference_tables/Todorov_etal_2019_dimorphdata_definitions.csv`.
