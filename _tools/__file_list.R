...
source(file.path(root_dir, "_tools", "openxlsx_compat.R"))
...
if (length(formula_mismatches)) {
  stop("Non-canonical Sheet1 naming formula(s): ", paste(formula_mismatches, collapse = ", "),
       ". Review explicitly; __file_list.R will not overwrite them.")
}
...
writeData(
  wb,
  sheet    = "Sheet1",
  x        = "Public TSV match from AUTO_Public_TSV_FileList (generated by _tools/__file_list.R; do not edit manually)",
  startCol = 13,
  startRow = 1,
  colNames = FALSE
)
