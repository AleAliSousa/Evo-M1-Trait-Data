  ...
  list(
    ...
    fields = list(
      ...
      `Note about item` = paste0(
        ...
        "Zilles_Rehkamper_1988; the registry Item name keeps the umlaut, which is what the ",
        "volumes merges look up."),
      `Progress stage` = "FINISHED",
      Snapshot = "Zilles_Rehkamper_1988_Table12-2_snapshot.xlsx",
      `Data readable file, can use this` = "Zilles_Rehkamper_1988_Table12-2.csv",
